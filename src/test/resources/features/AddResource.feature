Feature: Add planets and moons to the planetarium database
  ...
  Scenario Outline: User can add new moons to the table with valid png
    ...
    Examples:
      |image file|
      |C:\Users\kerbl\Desktop\PlanetariumSetup\db-setup\src\test\resources\Celestial-Images\paint.png|
  ...
  Scenario Outline: User can not add new planet to table with invalid data
    ...
    Examples:
      ...
      |                               |C:\Users\kerbl\Desktop\PlanetariumSetup\db-setup\src\test\resources\Celestial-Images\moon.jpg|Invalid planet name|
      |This_planets_name_is_too_longgg|C:\Users\kerbl\Desktop\PlanetariumSetup\db-setup\src\test\resources\Celestial-Images\moon.jpg|Invalid planet name|
      |Jupiter!?()<>                  |C:\Users\kerbl\Desktop\PlanetariumSetup\db-setup\src\test\resources\Celestial-Images\moon.jpg|Invalid planet name|
      |Earth                          |C:\Users\kerbl\Desktop\PlanetariumSetup\db-setup\src\test\resources\Celestial-Images\moon.jpg|Invalid planet name|
    ...
    Examples:
      ...
      |                               |2        |C:\Users\kerbl\Desktop\PlanetariumSetup\db-setup\src\test\resources\Celestial-Images\moon.jpg|Invalid moon name|
      |This_moons_name_is_tooo_longggg|2        |C:\Users\kerbl\Desktop\PlanetariumSetup\db-setup\src\test\resources\Celestial-Images\moon.jpg|Invalid moon name|
      |Moon!?<>(){}                   |2        |C:\Users\kerbl\Desktop\PlanetariumSetup\db-setup\src\test\resources\Celestial-Images\moon.jpg|Invalid moon name|
      |Titan                          |2        |C:\Users\kerbl\Desktop\PlanetariumSetup\db-setup\src\test\resources\Celestial-Images\moon.jpg|Invalid moon name|
      |Moon Number_23-19              |4        |C:\Users\kerbl\Desktop\PlanetariumSetup\db-setup\src\test\resources\Celestial-Images\moon.jpg|Invalid planet id|
